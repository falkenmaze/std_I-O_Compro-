...
An array *x* is lexicographically smaller than an array *y* if there exists an index *i* such that *xᵢ<yᵢi*, and *xⱼ=yⱼ* for all *1≤j<i*. Less formally, at the first index *i* in which they differ, *xᵢi<yᵢi*. For example [0, 2, 4, 3] is lexicographically smaller than [0, 3, 5, 0].
...
space-separated integers *a1, a2, …, an* (*0≤aᵢ≤100*) — the elements of the array *a*.
